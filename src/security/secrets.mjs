...
const RULES = [
  ...
  { name: 'google-api-key', confidence: 'high', pattern: /\bAIza[0-9A-Za-z_-]{30,}\b/g },
  { name: 'slack-token', confidence: 'high', pattern: /\bxox[baprs]-[A-Za-z0-9-]{20,}\b/g },
  { name: 'stripe-secret', confidence: 'high', pattern: /\bsk_(?:live|test)_[A-Za-z0-9]{20,}\b/g },
  { name: 'npm-token', confidence: 'high', pattern: /\bnpm_[A-Za-z0-9]{30,}\b/g },
